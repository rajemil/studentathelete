<x-guest-layout>
    <form method="POST" action="{{ route('register.coach') }}">
        @csrf
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <x-input-label for="field_expertise" value="Field Expertise" />
                ...
                <div>
                    <x-input-label for="profession" value="Profession / Specialization" />
